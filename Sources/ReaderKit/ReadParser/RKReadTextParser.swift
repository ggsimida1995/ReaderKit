...
class RKReadTextParser: NSObject {
    ...
    ///   - content: 小说内容
    /// - Returns: 章节列表
    private class func parser(bookID: String, content: String) -> [RKReadChapterListModel] {
        // 章节列表
        ...
        if !results.isEmpty {
            ...
            // 记录最后一个章节对象
            var lastChapterModel: RKReadChapterModel?
    ...
    /// - Returns: 章节列表对象
    private class func GetChapterListModel(chapterModel:RKReadChapterModel) ->RKReadChapterListModel {
