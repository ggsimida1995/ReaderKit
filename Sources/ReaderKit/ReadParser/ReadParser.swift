...
/// 解析完成
typealias DZMParserCompletion = (_ readModel: ReadModel?) ->Void
...
class ReadParser: NSObject {
    ...
    /// - Returns: 内容分页列表
    @objc class func pageing(attrString:NSAttributedString, rect:CGRect, isFirstChapter:Bool = false, isContentEmpty:Bool = false) ->[ReadPageModel] {
