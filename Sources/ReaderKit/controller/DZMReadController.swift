...
class DZMReadController: DZMViewController,UIPageViewControllerDelegate,UIPageViewControllerDataSource,DZMPageViewControllerDelegate,DZMCoverControllerDelegate,DZMReadContentViewDelegate,DZMReadCatalogViewDelegate,DZMReadMarkViewDelegate {
...
//        
//        // 清空指定书籍缓存
//        DZMKeyedArchiver.remove(folderName: readModel.bookID)
//        
