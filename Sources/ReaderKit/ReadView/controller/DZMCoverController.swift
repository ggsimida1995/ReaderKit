...
// 定义代理协议
protocol DZMCoverControllerDelegate: AnyObject {
    func coverController(_ coverController: DZMCoverController, currentController: UIViewController?, finish: Bool)
...
class DZMCoverController: UIViewController {
    // 代理
    weak var delegate: DZMCoverControllerDelegate?
    // 手势启用状态
...
extension DZMCoverController: UIGestureRecognizerDelegate {
