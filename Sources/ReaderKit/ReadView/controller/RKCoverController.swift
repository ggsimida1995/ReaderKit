...
// 定义代理协议
protocol RKCoverControllerDelegate: AnyObject {
    func coverController(_ coverController: RKCoverController, currentController: UIViewController?, finish: Bool)
...
class RKCoverController: UIViewController {
    // 代理
    weak var delegate: RKCoverControllerDelegate?
    // 手势启用状态
...
extension RKCoverController: UIGestureRecognizerDelegate {
