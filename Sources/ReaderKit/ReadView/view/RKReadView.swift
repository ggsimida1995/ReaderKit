...
class RKReadView: UIView {
    ...
    var pageModel:RKReadPageModel! {
        ...
        didSet{
            ...
            frameRef = RKCoreText.GetFrameRef(attrString: pageModel.showContent, rect: CGRect(origin: CGPoint.zero, size: pageModel.contentSize))
        }
    }
    ...
    var content:NSAttributedString! {
        ...
        didSet{
            ...
            frameRef = RKCoreText.GetFrameRef(attrString: content, rect: CGRect(origin: CGPoint.zero, size: DZM_READ_VIEW_RECT.size))
        }
    }
...
//        
//        // 设置虚线框的路径
//        let path = UIBezierPath(rect: CGRect(origin: CGPoint.zero, size: _READ_VIEW_RECT.size)) // 沿着视图边界绘制矩形
