...
@objc protocol PageViewControllerDelegate: NSObjectProtocol {
    ...
    /// 获取上一页
    @objc optional func pageViewController(_ pageViewController: PageViewController, getViewControllerBefore viewController: UIViewController!)
    
    /// 获取下一页
    @objc optional func pageViewController(_ pageViewController: PageViewController, getViewControllerAfter viewController: UIViewController!)
}

class PageViewController: UIPageViewController, UIGestureRecognizerDelegate {

    // 自定义tap手势的相关代理
    var aDelegate:PageViewControllerDelegate?
